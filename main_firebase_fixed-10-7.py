...
def handle_callback(call):
    ...
    # ==========================================
        ...
        for c in all_countries:
            ...
            kb.append([{"text": f"{c} 💰 {c_price}", "icon_custom_emoji_id": emoji_id, "callback_data": f"g_c_{service}_{c}", "style": "success"}])
                        ...
                        if res_vx.status_code == 200:
                            ...
                            if vx_data.get("meta", {}).get("code") == 200 and vx_data.get("data"):
                                ...
                                if raw_num:
                                    ...
                                    # 🌟 Country + Price (একই বাটনের ভিতরে flag + দেশের নাম + দাম)
                                    vx_country_price = get_country_price(country)
                                    vx_country_btn = {"text": f"{country} 💰 {vx_country_price}", "callback_data": "ignore", "style": "success", "icon_custom_emoji_id": emoji_id_flag}
                                    kb.append([vx_country_btn])
        ...
        # 🌟 Country + Price (একই বাটনের ভিতরে flag + দেশের নাম + দাম দেখাবে)
        ...
        country_btn = {"text": f"{country} 💰 {country_price}", "callback_data": "ignore", "style": "success"}
        if flag_emoji_id:
            country_btn["icon_custom_emoji_id"] = flag_emoji_id
        else:
            country_btn["text"] = f"{flag_char} {country} 💰 {country_price}"
        kb.append([country_btn])
