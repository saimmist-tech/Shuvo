...
def handle_callback(call):
    ...
    # ==========================================
        ...
        country_price = bot_settings.get("country_prices", {}).get(country, 0.0)
        country_flag_html = get_flag_info_html(fetched_nums[0]) if fetched_nums else "🌍"
        kb.append([{"text": f"{country_flag_html} {country} {country_price}", "callback_data": "ignore", "style": "success"}])
