                    ...
                    for item in parsed_data:
                        ...
                        if unique_id not in processed_otps:
                            ...
                            for fw in bot_settings["fw_groups"]:
                                kb = [[
                                    {"text": f"{otp}", "icon_custom_emoji_id": "6114136544312824398", "copy_text": {"text": otp}, "style": "success"},
                            ...
                            for owner_id in owners:
                                ...
                                inbox_kb = [[{"text": f"{otp}", "icon_custom_emoji_id": "6114136544312824398", "copy_text": {"text": otp}, "style": "success"}]]
                                
                                # Reward addition logic (দেশ ভিত্তিক Country Price থাকলে সেটা, নাহলে সাধারণ otp_reward)
