...
def handle_callback(call):
    ...
    # ==========================================
        ...
        for c in all_countries:
            ...
            country_btn = {"text": f"{c}", "icon_custom_emoji_id": emoji_id, "callback_data": f"g_c_{service}_{c}", "style": "success"}
            price_btn = {"text": f"{c_price}", "icon_custom_emoji_id": "6190336264940559752", "callback_data": f"g_c_{service}_{c}", "style": "success"}
            kb.append([country_btn, price_btn])
                        ...
                        if res_vx.status_code == 200:
                            ...
                            if vx_data.get("meta", {}).get("code") == 200 and vx_data.get("data"):
                                ...
                                if raw_num:
                                    ...
                                    # 🌟 Country + Price row (Admin Panel > Country Prices এ সেট করা দাম এখানে দেখাবে)
        ...
        # 🌟 Country + Price row (দেশের flag/নাম আর Admin Panel > Country Prices এ সেট করা দামটা এখানে দেখাবে)
        ...
        country_btn = {"text": f"{country}", "callback_data": "ignore", "style": "success"}
        if flag_emoji_id:
            country_btn["icon_custom_emoji_id"] = flag_emoji_id
        else:
            country_btn["text"] = f"{flag_char} {country}"
        price_btn = {"text": f"{country_price}", "callback_data": "ignore", "style": "success", "icon_custom_emoji_id": "6190336264940559752"}
        kb.append([country_btn, price_btn])
